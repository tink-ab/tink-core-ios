...
public protocol CredentialsService {
    ...
    func refresh(id: Credentials.ID, forceAuthenticate: Bool, refreshableItems: RefreshableItems, optIn: Bool, completion: @escaping (Result<Void, Error>) -> Void) -> RetryCancellable?
